# Spreadsheet import for runZero

Custom integration designed to import and merge asset details from a spreadsheet to runZero assets and custom attributes.
...
- Clone runZero/custom_integrations/Spreadsheet/.env_sample to .env under the same directory

```
cd runZero/sdk-sample-scripts/Spreadsheet
cp .env_sample .env
```
...
- Modify the import script to map values from the spreadsheet's column headers to runZero attributes (also serve to merge assets): https://runzeroinc.github.io/runzero-sdk-py/index.html#custom-import-asset-field-mappings

    - Add attributes to for loop starting at line 49 following the example pattern

    - Assign the above variables to the ImportAsset class varaibles starting at line 81 
