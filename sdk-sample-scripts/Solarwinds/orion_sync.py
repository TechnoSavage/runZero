...
# Docs: https://github.com/solarwinds/orionsdk-python
# Docs: https://github.com/solarwinds/orionsdk-python/tree/master
# Docs: https://www.networkmanagementsoftware.com/solarwinds-orion-api-sdk-getting-started-part-1/
# Docs: https://www.networkmanagementsoftware.com/solarwinds-orion-api-sdk-using-swql-rest-and-curl-part-2/
# Docs: https://www.networkmanagementsoftware.com/solarwinds-orion-api-sdk-scripting-with-python-part-3/
...
def get_assets(dc=ORION_DATA_CENTER, token=SWOKEN):
    server = f"https://api.{ORION_DATA_CENTER}.cloud.solarwinds.com/v1/metrics"
    swis = orionsdk.SwisClient(server, "username", "password")
    try:
        results = swis.query("SELECT * FROM Orion.Nodes")
...
def main():
    ...
    assets = swis.query("SELECT * FROM Orion.Nodes")
    
    assets_parsed = parse_response(assets)

    # Format asset list for import into runZero
    import_assets = build_assets_from_json(assets_parsed)
