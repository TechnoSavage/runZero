# runZero Custom Integration to populate software inventory via WinRM
...
WINRM_CUSTOM_SOURCE_ID = os.environ['INTEGRATION_CUSTOM_SOURCE_ID']
WINRM_IMPORT_TASK_NAME = os.environ['INTEGRATION_IMPORT_TASK_NAME']
